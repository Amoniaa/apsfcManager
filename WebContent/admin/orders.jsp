                          ...
                          <c:forEach items="${page.list }" var="order" >
                             <tr>
								...
								<td class="line_table" align="center"><a
									href="${pageContext.request.contextPath}/ordersServlet?action=confirm&&id=${order.id}&&curPage=${page.curPage }">确认</a></td>
								<td class="line_table" align="center"><a
									href="${pageContext.request.contextPath}/ordersServlet?action=delete&&id=${order.id}&&curPage=${page.curPage }">取消</a></td>
							</tr>
							</c:forEach>	
							<tr>
								...
								<c:otherwise>
									<a href="${pageContext.request.contextPath }/ordersServlet?action=infolist&&curPage=1">[首页]</a>
								</c:otherwise>
								</c:choose>
								...
								<c:otherwise>
									<a href="${pageContext.request.contextPath }/ordersServlet?action=infolist&&curPage=${page.totalPage}">[尾页]</a>&nbsp;&nbsp; 
								</c:otherwise>
								</c:choose>
								...
								<c:otherwise>
									<a href="${pageContext.request.contextPath }/ordersServlet?action=infolist&&curPage=${page.curPage-1}">[上一页]</a>
								</c:otherwise>
								</c:choose>
								...
								<c:otherwise>
									<a href="${pageContext.request.contextPath }/ordersServlet?action=infolist&&curPage=${page.curPage+1}">[下一页]</a>
								</c:otherwise>
								</c:choose>
