                        ...
                        <table  class="table table-striped table-sm" >
                          <thead>
                            <tr>
                          	...
                          	<tbody>
                          <c:forEach items="${requestScope.page.list }" var="board">
							...
							<tr>
								...
								<td class="line_table" align="center"><a
									href="${pageContext.request.contextPath }/boardServlet?action=adminDelete&&id=${board.id}&&curPage=${page.curPage}">删除</a></td>
							</tr>
							</c:forEach>
							...
							<tr>
								...
								<c:otherwise>
									<a href="${pageContext.request.contextPath }/boardServlet?action=find&&curPage=1">[首页]</a>
								</c:otherwise>
								</c:choose>
								...
								<c:otherwise>
									<a href="${pageContext.request.contextPath }/boardServlet?action=find&&curPage=${page.totalPage}">[尾页]</a>&nbsp;&nbsp; 
								</c:otherwise>
								</c:choose>
								...
								<c:otherwise>
									<a href="${pageContext.request.contextPath }/boardServlet?action=find&&curPage=${page.curPage-1}">[上一页]</a>
								</c:otherwise>
								</c:choose>
								...
								<c:otherwise>
									<a href="${pageContext.request.contextPath }/boardServlet?action=find&&curPage=${page.curPage+1}">[下一页]</a>
								</c:otherwise>
								</c:choose>
