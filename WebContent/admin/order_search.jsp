			...
			<div
				...
				<ul
					...
					<li class="nav-item"><a
						...
						class="nav-link logout">退出<i class="fa fa-sign-out"></i></a></li>
				</ul>
			</div>
		</div>
		</nav> </header>
				...
				<div class="col-lg-6">
					<div class="card" style="width: 1200px;">
						...
						<div class="card-header d-flex align-items-center">
							<h3 class="h4">销售订单查询</h3>
						</div>

						<form
							action="${pageContext.request.contextPath }/ordersServlet?action=adminSearch"
							name="form1" method="post">
							<h5>&nbsp;</h5>
							<div align="center">根据用户ID查询:&nbsp;&nbsp;&nbsp;&nbsp;
								<input style="width: 200px ;display:inline;" type="text" name="userid" size="20"
									value="${requestScope.orderInfo.userid eq 0?'':requestScope.orderInfo.userid  }"
									class="mr-3 form-control">
								<input style="display:inline;" type="submit" class="btn btn-primary" value="查询">
							</div>
							<h5>&nbsp;</h5>
							<div align="center">根据菜品名称查询:
								<input style="width: 200px ;display:inline;" type="text" name="menuname"
									size="20" value="${requestScope.orderInfo.menuname }"
									class="mr-3 form-control">
								<input type="submit" class="btn btn-primary" value="查询">
							</div>
							<h5>&nbsp;</h5>
							<div align="center">根据销售日期查询:
								<input style="width: 200px ;display:inline;" type="text" name="date" size="20"
									value="${requestScope.orderInfo.date }"
									class="mr-3 form-control">
								<input type="submit" class="btn btn-primary" value="查询">
							</div>
							<h5>&nbsp;</h5>
										...
										<tr>
											<td class="line_table" align="center" colspan="11"
												height="20"><span class="left_bt2">第${page.curPage }页
													...
													<c:otherwise>
														<a
															href="${pageContext.request.contextPath }/ordersServlet?action=adminSearch&&curPage=1">[首页]</a>
													</c:otherwise>
												</c:choose> <c:choose>
													...
													<c:otherwise>
														<a
															href="${pageContext.request.contextPath }/ordersServlet?action=adminSearch&&curPage=${page.totalPage}&&userid=${requestScope.orderInfo.userid}&&menuname=${requestScope.orderInfo.menuname }&&date=${requestScope.orderInfo.date }">[尾页]</a>&nbsp;&nbsp; 
								</c:otherwise>
												</c:choose> <c:choose>
													<c:when test="${page.curPage eq 1 }">
													...
													<c:otherwise>
														<a
															href="${pageContext.request.contextPath }/ordersServlet?action=adminSearch&&curPage=${page.curPage-1}&&userid=${requestScope.orderInfo.userid}&&menuname=${requestScope.orderInfo.menuname }&&date=${requestScope.orderInfo.date }">[上一页]</a>
													</c:otherwise>
												</c:choose> <c:choose>
													<c:when test="${page.curPage eq page.totalPage }">
													...
													<c:otherwise>
														<a
															href="${pageContext.request.contextPath }/ordersServlet?action=adminSearch&&curPage=${page.curPage+1}&&userid=${requestScope.orderInfo.userid}&&menuname=${requestScope.orderInfo.menuname }&&date=${requestScope.orderInfo.date }">[下一页]</a>
													</c:otherwise>
												</c:choose></td>
										</tr>
									</tbody>
