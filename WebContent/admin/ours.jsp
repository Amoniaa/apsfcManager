				...
				<div class="col-lg-6">
					<div class="card" style="width: 1200px;">
						...
						<div class="card-header d-flex align-items-center">
							<h3 class="h4">更新关于我们</h3>
						</div>

							<div class="card-body">
								
							<form
								action="${pageContext.request.contextPath }/oursServlet?action=update"
								...
								<div class="form-group row">
									...
									<div class="col-sm-5">
										<input id="inputHorizontalSuccess" type="text" name="name"
											class="form-control form-control-success" value="${requestScope.ours.name }">
									</div>
								</div>
								<div class="form-group row">

									<label class="col-sm-1 form-control-label">内容:</label>
									<div class="col-sm-9 ">
										<textarea name="content" style="width: 1000px; height: 200px;"
											class="form-control form-control-warning">${requestScope.ours.content }</textarea>
									</div>
								</div>
								<div class="form-group row">
