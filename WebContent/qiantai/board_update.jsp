	...
	<table width="900" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td align="center" valign="top" height="400">
				<form method="post" action="${pageContext.request.contextPath }/boardServlet?action=update&&username=${requestScope.board.username}&&id=${requestScope.board.id}"
		...
		<tr>
			...
			<a href="${pageContext.request.contextPath }/boardServlet?action=show&&username=${sessionScope.user.name}&&curPage=${page.curPage }" target="_self"><input type="submit" value="返回"></a>
			</td>
		</tr>
		<tr>
