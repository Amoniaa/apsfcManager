...
<body>
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
          ...
          <ul class="list-unstyled">
			...
			<div class="content-inner">
				...
				<div class="container-fluid">
					<h2 class="no-margin-bottom">公告信息管理</h2>
				</div>
				</header>
	  ...
	  <div class="card-header d-flex align-items-center">
                      <h3 class="h4" >添加新公告</h3>
                    </div>
							<div class="card-body">
								
								<form
									action="${pageContext.request.contextPath }/noticeServlet?action=add"
									method="post" onSubmit="return verifyInfo()">
									<div class="form-group row">

										<label class="col-sm-1 form-control-label">公告标题:</label>
										<div class="col-sm-5">
									...
									<div class="form-group row">
										...
										<label class="col-sm-1 form-control-label">公告内容:</label>
										<div class="col-sm-9 ">
