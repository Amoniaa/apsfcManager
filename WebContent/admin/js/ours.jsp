		...
		<tr>
			<td valign="top" bgcolor="#F7F8F9">
				...
				<div align="center">
					...
					<form action="${pageContext.request.contextPath }/noticeServlet?action=update" method="post"
						...
						<table id="table2" class="line_table"
							...
							<tr>
								<td class="line_table" align="right" width="10%"><span
									class="left_bt2">关于我们标题：</span></td>
								<td class="line_table" width="90%"><input type="text"
									name="name" size="45" value="${requestScope.ours.name }"></td>
							</tr>
							<tr>
								<td class="line_table" align="right" width="10%"><span
									class="left_bt2">关于我们内容：</span></td>
								<td class="line_table" width="90%"><textarea rows="14"
										name="content" cols="105" value="${requestScope.ours.name }"></textarea></td>
							</tr>
							<tr>
