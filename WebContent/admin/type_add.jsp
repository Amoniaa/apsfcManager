           ...
           <div class="col-lg-6" >
                  <div class="card" style="width: 1200px;">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4" >添加新类别</h3>
                    </div>
                          <label for="inlineFormInputGroup" class="sr-only">菜品类别</label>
                         <form action="${pageContext.request.contextPath }/typesServlet?action=add" method="post" name="form1"
                         onSubmit="return verifyInfo()">
                         							<h5>&nbsp;</h5>
                          <div align="center">
                          <input style="width:500px" id="inlineFormInputGroup" name="name" type="text" placeholder="菜品类别" class="mr-3 form-control">
                        </div>
                        							<h5>&nbsp;</h5>
