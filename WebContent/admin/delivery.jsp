	...
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
			...
			<div class="content-inner">
				...
				<div class="container-fluid">
					<h2 class="no-margin-bottom">辅助功能</h2>
				</div>
				</header>
			...
			<div class="col-lg-6">
					<div class="card" style="width: 1200px;">
						...
						<div class="card-header d-flex align-items-center">
							<h3 class="h4">更新配送说明</h3>
						</div>
							<div class="card-body">
								
					<form action="${pageContext.request.contextPath }/deliveryServlet?action=update" method="post" name="form1"
						onSubmit="return verifyInfo()">

								<div class="form-group row">

									<label class="col-sm-2 form-control-label">配送说明标题:</label>
									<div class="col-sm-5">
										<input id="inputHorizontalSuccess" type="text" name="name"
											class="form-control form-control-success" value="${requestScope.delivery.name }">
									</div>
								</div>
								<div class="form-group row">

									<label class="col-sm-2 form-control-label">午餐配送时间:</label>
									<div class="col-sm-5">
										<input id="inputHorizontalSuccess" type="text" name="lunchtime"
											class="form-control form-control-success" value="${requestScope.delivery.lunchtime }">
									</div>
								</div>
								<div class="form-group row">

									<label class="col-sm-2 form-control-label">晚餐配送时间:</label>
									<div class="col-sm-5">
										<input id="inputHorizontalSuccess" type="text" name="dinnertime"
											class="form-control form-control-success" value="${requestScope.delivery.dinnertime }">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-5">
										<input id="inputHorizontalSuccess" type="text" name="phone"
											class="form-control form-control-success" value="${requestScope.delivery.phone }">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-5">
										<input id="inputHorizontalSuccess" type="text" name="contacts"
											class="form-control form-control-success" value="${requestScope.delivery.contacts }">
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-sm-9 ">
										<textarea name="content" style="width: 800px; height: 100px;"
											class="form-control form-control-warning">${requestScope.delivery.content }</textarea>
									</div>
								</div>
								<div class="form-group row">
