  ...
  <body>
    <div class="page">
      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <div class="content-inner">
         ...
         <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">菜单类别管理</h2>
            </div>
          </header>
      ...
      <div class="card-header d-flex align-items-center">
                      <h3 class="h4" >类别信息修改</h3>
                    </div>

                          <label for="inlineFormInputGroup" class="sr-only">菜品类别</label>
                         <form action="${pageContext.request.contextPath }/typesServlet?action=update" method="post" name="form1"
                         onSubmit="return verifyInfo()">
                         <h5>&nbsp;</h5>
                         <div align="center">
                          	<input style="width:500px" type="text" name="name" size="45" value="${requestScope.type.name}" class="mr-3 form-control">
							</div>
