                        ...
                        <table  class="table table-striped table-sm" >
                          <thead>
                            <tr>
                              ...
                              <th style="text-align:center;">市场价销售数量</th>
                              <th style="text-align:center;">会员单价</th>
                              <th style="text-align:center;">会员价销售数量</th>
                            </tr>
                          </thead>
                          <tbody>
                          <c:forEach items="${requestScope.page.list }" var="menus">
							...
							<tr>
								...
								<td class="line_table" align="center"><a
									href="${pageContext.request.contextPath }/menusServlet?action=updateMenusPre&&id=${menus.id}&&curPage=${page.curPage}">修改</a></td>
								<td class="line_table" align="center"><a
									href="${pageContext.request.contextPath }/menusServlet?action=delete&&id=${menus.id}&&curPage=${page.curPage}">删除</a></td>
							</tr>
							</c:forEach>
